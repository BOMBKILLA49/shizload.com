...
(function ($) {
    ...
    // Checkmarks Slider
    $(document).ready(function() {
        class CheckmarksSlider {
            constructor() {
                this.slider = document.getElementById('checkmarks-slider');
                this.prevBtn = document.getElementById('prev-checkmark');
                this.nextBtn = document.getElementById('next-checkmark');
                this.dotsContainer = document.getElementById('checkmarks-dots');
                this.items = this.slider ? this.slider.querySelectorAll('.check-p-item') : [];
                this.currentSlide = 0;
                this.itemsPerSlide = 3;
                this.totalSlides = this.items.length > 0 ? Math.ceil(this.items.length / this.itemsPerSlide) : 0;
            ...
            bindEvents() {
                ...
                if (this.dotsContainer) {
                    this.dotsContainer.addEventListener('click', (e) => {
                        if (e.target.classList.contains('check-p-dot')) {
            ...
            updateDots() {
                ...
                const dots = this.dotsContainer.querySelectorAll('.check-p-dot');
